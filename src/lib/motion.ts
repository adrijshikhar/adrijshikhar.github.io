import { animate, createTimeline, onScroll, stagger, utils, spring } from 'animejs';
...
export const SPRING = spring({ stiffness: 200, damping: 24 });

export const prefersReducedMotion =
  typeof window !== 'undefined' &&
  window.matchMedia('(prefers-reduced-motion: reduce)').matches;

export { animate, createTimeline, onScroll, stagger, utils, spring };
