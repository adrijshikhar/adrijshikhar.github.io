...
![The profile rendered on GitHub: a typing banner, the "For humans" section, self-computed stat badges (contributions, followers, repos, years), and the contribution activity graph.](/blog/profile-readme.png)
