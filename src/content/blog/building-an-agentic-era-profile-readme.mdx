...
<figure style="margin:1.75rem 0;text-align:center;">
  <img
    src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3500&pause=900&center=true&vCenter=true&width=760&color=58A6FF&lines=I+build+real-time+data+infrastructure;CDC+%C2%B7+streaming+%C2%B7+distributed+systems;Where+data+infra+meets+AI"
    alt="Animated typing banner from the profile README"
    style="max-width:100%;"
  />
  <img
    src="https://raw.githubusercontent.com/adrijshikhar/adrijshikhar/output/pacman-dark.svg"
    alt="Pac-Man eating the contribution graph (live, regenerated daily)"
    style="display:block;width:100%;margin-top:0.75rem;border-radius:10px;"
  />
  <figcaption style="margin-top:0.6rem;font-size:0.8rem;color:var(--muted);">
    Live from the profile — the banner types itself and the Pac-Man graph regenerates daily.
  </figcaption>
</figure>
