...
draft: false
canonicalUrl: "https://adrijshikhar.dev/blogs/building-a-pure-go-binlog-analyzer"
---
...
You are sitting in an SSH session at 2 AM, looking at a 1.2 GB text stream through a terminal pager.
A replication thread lagged by 45 minutes, or an unexpected schema rewrite blocked queries, or an unexplained spike in binlog volume exhausted disk space.
...
<div class="my-8 flex justify-center not-prose overflow-x-auto py-2">
  <svg viewBox="0 0 680 320" class="w-full max-w-2xl h-auto font-mono text-xs select-none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <marker id="arrow" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 1 L 8 5 L 0 9 z" fill="var(--primary)" />
      </marker>
      <marker id="arrow-amber" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 1 L 8 5 L 0 9 z" fill="#FCD34D" />
      </marker>
      <marker id="arrow-green" viewBox="0 0 10 10" refX="6" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
        <path d="M 0 1 L 8 5 L 0 9 z" fill="#7EE787" />
      </marker>
    </defs>

    {/* Top Node: Binlog Raw Event */}
    <rect x="220" y="16" width="240" height="52" rx="8" fill="var(--card)" stroke="var(--border)" stroke-width="1.5"/>
    <text x="340" y="38" text-anchor="middle" fill="var(--foreground)" font-weight="600" font-size="13">Binlog Raw Event</text>
    <text x="340" y="54" text-anchor="middle" fill="var(--muted-foreground)" font-size="11">Binary Stream / Replication Feed</text>

    {/* Fork Line */}
    <path d="M 340 68 L 340 100" stroke="var(--border)" stroke-width="1.5" />
    <path d="M 170 100 L 510 100" stroke="var(--border)" stroke-width="1.5" />
    <path d="M 170 100 L 170 128" stroke="var(--primary)" stroke-width="1.5" marker-end="url(#arrow)" />
    <path d="M 510 100 L 510 128" stroke="#FCD34D" stroke-width="1.5" marker-end="url(#arrow-amber)" />

    {/* Left Engine: go-mysql Workhorse */}
    <rect x="60" y="132" width="220" height="66" rx="8" fill="var(--card)" stroke="var(--primary)" stroke-width="1.5"/>
    <text x="170" y="156" text-anchor="middle" fill="var(--primary)" font-weight="600" font-size="13">go-mysql Workhorse</text>
    <text x="170" y="174" text-anchor="middle" fill="var(--foreground)" font-size="11">Pure Go Ingest &amp; Indexer</text>
    <text x="170" y="190" text-anchor="middle" fill="var(--muted-foreground)" font-size="11">Primary Engine · Zero Deps</text>

    {/* Right Engine: mysqlbinlog Oracle */}
    <rect x="400" y="132" width="220" height="66" rx="8" fill="var(--card)" stroke="#FCD34D" stroke-width="1.5"/>
    <text x="510" y="156" text-anchor="middle" fill="#FCD34D" font-weight="600" font-size="13">mysqlbinlog Oracle</text>
    <text x="510" y="174" text-anchor="middle" fill="var(--foreground)" font-size="11">Official Server Utility</text>
    <text x="510" y="190" text-anchor="middle" fill="var(--muted-foreground)" font-size="11">Ground Truth · Secondary</text>

    {/* Merge Line to Diff Drawer */}
    <path d="M 170 198 L 170 230" stroke="var(--primary)" stroke-width="1.5" />
    <path d="M 510 198 L 510 230" stroke="#FCD34D" stroke-width="1.5" />
    <path d="M 170 230 L 510 230" stroke="var(--border)" stroke-width="1.5" />
    <path d="M 340 230 L 340 250" stroke="#7EE787" stroke-width="1.5" marker-end="url(#arrow-green)" />

    {/* Bottom Node: Visual Diff Drawer */}
    <rect x="200" y="254" width="280" height="54" rx="8" fill="var(--card)" stroke="#7EE787" stroke-width="1.5"/>
    <text x="340" y="276" text-anchor="middle" fill="#7EE787" font-weight="600" font-size="13">Visual Diff Drawer</text>
    <text x="340" y="294" text-anchor="middle" fill="var(--foreground)" font-size="11">Field-by-Field Divergence Highlighting</text>
  </svg>
</div>
...
Because MySQL's internal `end_log_pos` header field is a 32-bit unsigned integer (`uint32`), any transaction that pushes a binlog file beyond 4 GiB causes subsequent positions to wrap around to zero (as detailed in our [first blog post](/blogs/mysql-binlog-4gib-position-wrap)).
