    ...
    <HoverCard>
      <a href={href} className="block text-inherit no-underline hover:text-inherit">
        ...
        <h3 className="mt-2 title-entry">
          <span className="transition-colors duration-[120ms] group-hover/list-item:text-accent">{title}</span>
          <span className="ml-1 text-xs text-muted transition-colors group-hover/list-item:text-accent">&rarr;</span>
        </h3>
      </a>
    </HoverCard>
  );
