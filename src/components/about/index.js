...
const About = () => {
	const birthDate = new Date('1998-09-26');
	...
	return (
		...
		>
			...
			<p className="lead mb-3">
				Welcome to my portfolio! I&apos;m a {age}-year-old graduate from IIT
				Roorkee. While my academic journey began in the world of chemistry, I
				quickly discovered my true passion for software development during my
				freshman year.
			</p>
			<p className="lead mb-3">
				...
				crafting software solutions that not only solve problems but also push
				the boundaries of innovation.
			</p>
			<p className="lead mb-3">
				Explore my portfolio to see the fruits of my labor, from web
				applications to mobile apps and everything in between. I&apos;m excited
				to share my journey and the projects that have shaped my development
				career. If you have any questions or would like to collaborate,
